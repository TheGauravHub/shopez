/* Design System and Global Styles for ShopEZ */
...
:root {
  ...
  --shadow-premium: 0 20px 25px -5px rgba(79, 70, 229, 0.05), 0 10px 10px -5px rgba(79, 70, 229, 0.02);
...
.btn-shop-now:disabled, .btn-add-cart:disabled {
...
.metric-icon-box.cyan {
  background-color: rgba(6, 180, 212, 0.1);
  color: var(--secondary);
}
