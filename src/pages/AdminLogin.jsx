...
const AdminLogin = () => {
  ...
  return (
    <div className="auth-wrapper">
      <div className="auth-visual" style={{ backgroundImage: "linear-gradient(140deg, rgba(15, 23, 42, 0.78), rgba(124, 58, 237, 0.48)), url('https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=1200&auto=format&fit=crop&q=80')" }}>
        <span className="hero-pill">Admin analytics</span>
        <h1>Operate ShopEZ from one premium dashboard.</h1>
        <p>Manage catalog, orders, revenue cards, tables, and inventory-ready workflows.</p>
      </div>
