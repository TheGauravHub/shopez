...
const Home = () => {
  ...
  const banners = [
    ...
    {
      title: 'Smart Mobiles & Accessories',
      desc: 'Stay connected with the latest 5G smartphones and smart wearables.',
  ...
  const categories = [
    ...
    {
      name: 'Electronics',
      image: 'https://images.unsplash.com/photo-1498049531479-7f71afae5d21?w=400&auto=format&fit=crop&q=80'
    },
    {
      name: 'Mobiles',
  ...
  return (
    <div className="container home-container">
      ...
      <section className="carousel-section">
        ...
        {/* Navigation Arrows */}
        <button className="carousel-arrow left flex-center" onClick={prevSlide}>
          <ChevronLeft size={24} />
        </button>
        <button className="carousel-arrow right flex-center" onClick={nextSlide}>
